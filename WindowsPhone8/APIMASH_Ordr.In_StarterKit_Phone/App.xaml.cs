...
using APIMASH_Ordr.In_StarterKit_Phone.ViewModels;
...
namespace APIMASH_Ordr.In_StarterKit_Phone
{
    public partial class App : Application
    {
        ...
        void ordrin_OnNetworkError(object sender, EventArgs e)
        {
            MessageBox.Show("There was a network error connecting to the server.  Please try again later.", "Ordr.In Reference App", MessageBoxButton.OK);
        ...
        {
            Globals.Instance.ordrin.OnNetworkError += ordrin_OnNetworkError;
            ...
            try
            {
                ...
                if (contents != null)
                {
                    if (MessageBox.Show("A problem occurred the last time you ran this application. Would you like to send an email to report it?", "Problem Report", MessageBoxButton.OKCancel) == MessageBoxResult.OK)
                    {
                        ...
                        email.To = ""; // separate email addresses using a ;
                        email.Subject = "ordr.in WP8 auto-generated problem report";
                        email.Body = contents;
